...
.. module:: generate_webpage
   ...
   :synopsis: Web page generation function
...
def generate_webpage(port_list):
    """
    This function generates the source code of the HTML page containing the list of open ports.

    :param args: Extracted ports list
    :type args: int
